...
public final static String PDF_PATH_PROPERTY="pdf.path";
    ...
    public final static String P2_1P="1p. Starpnokrāsa - pelēka/balta krāsa un spīdīga virsma";
    public final static String P2_0P="0p. Zemas intensitātes acetobaltais (AB). Mazizteikts AB, caurspīdīgi /daļēji caurspīdīgs AB. Sniega balta krāsa ar intensīvu virsmas spīdumu";
    public final static String P2_LABEL="Krāsa (pēc etiķskābes aplikācijas)";
    ...
    public final static String P5_LABEL="Bojājuma izmērs";
